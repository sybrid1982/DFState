...
/// <summary>
/// Handler is the function assigned to 'handle' the notification
/// First parameter is the sender
/// Second is the arguments/info
/// </summary>
...
/// 
/// When no sender is specified for the SenderTable, the notificationcenter
/// itself is used as the sender key
/// </summary>
...
public class NotificationCenter {
    #region Properties
    /// <summary>
    /// The Key is the notificationName
    /// The value is the SenderTable for that notification
    /// </summary>
    ...
    public void RemoveObserver(Handler handler, string notificationName, System.Object sender)
    {
        ...
        // Only take action if we monitor this notification
        if (!_table.ContainsKey(notificationName))
            return;
    ...
    public void PostNotification (string notificationName,
        System.Object sender, System.Object e)
    {
        if (string.IsNullOrEmpty(notificationName))
        {
